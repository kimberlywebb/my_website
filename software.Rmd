...
<center>
<img align="right" src="hex_stickers.png" style="width:35%">
</center>

- [COMBO:](https://kimhochstedler.github.io/COMBO/) COMBO provides a set of functions for the analysis of regression models with binary outcome misclassification. 
...
- [carnegiecolors:](https://github.com/kimhochstedler/carnegiecolors) R package with color palettes matching Carnegie Mellon University's official branding.
- [maizeandblue:](https://github.com/kimhochstedler/maizeandblue) R package with color palettes matching the University of Michigan's official branding and with color palettes inspired by local eateries in Ann Arbor, Michigan. 
...
- A template and brief tutorial for creating websites using GitHub Pages and R is available on my [GitHub page](https://github.com/kimhochstedler/website_template).
