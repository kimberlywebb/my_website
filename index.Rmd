...
data <- data.frame(
  ...
  content = c("Carnegie Mellon", "SIBS", "Helgeson Lab", "NIH",
              "UMich", "MROQC", "Cornell", "CTI", "rddapp"),
  ...
  style = c("background-color: #b00; border-color: #666; color: #e0e0e0",
            ...
            "background-color: #FFFFFF; border-color: #006699; color: #DF1E12",
            "background-color: #F1EFDC; border-color: #DBE1E2; color: #3E4159"))
...
- **CTI:** Fellow in Cornell University's Center for Teaching Innovation [Graduate Teaching Fellowship](https://teaching.cornell.edu/cti-graduate-teaching-fellowship)
- **rddapp:** Research assistantship with [Felix Thoemmes](https://www.human.cornell.edu/people/fjt36) to update the `rddapp` [R package](https://www.rdocumentation.org/packages/rddapp/versions/1.2.1).
