...
Please see a full list on my [CV](https://github.com/kimberlywebb/docs/blob/0d5ba59c2cf51885c5950e07a2836194abd4b368/KAH_Webb_CV.pdf?raw=true).
...
-   **KAH Webb** and MT Wells, ["Effect estimation in the presence of a misclassified binary mediator"](https://github.com/kimberlywebb/docs/blob/de4d9a41d8435258c42005bcf936c6f20021758b/KAH_Webb_WSDS2024_slides_website_version.pdf?raw=true). Invited talk at *Women in Statistics and Data Science*, Reston, VA. October 2024.

$~$

#### Past

-   **KAH Webb**, SA Riley, and MT Wells, ["An assessment of racial disparities in pretrial decision-making using misclassification models"](https://github.com/kimberlywebb/docs/blob/f9ce847a3ce17316370fb4a6e9044c39683b00ff/KAH_Webb_JSM2024_Slides_WebsiteVersion.pdf?raw=true). Contributed talk at the *Joint Statistical Meetings*, Portland, OR. August 2024. 
